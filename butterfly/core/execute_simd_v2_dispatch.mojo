...
fn dispatch_single_transformation_v2[
    N: Int
](mut state: QuantumState, t: Transformation):
    """Dispatch a single transformation to specialized SIMD kernels."""
...
fn execute_transformations_simd_v2[
    ...
    for i in range(len(transformations)):
        dispatch_single_transformation_v2[N](state, transformations[i])
